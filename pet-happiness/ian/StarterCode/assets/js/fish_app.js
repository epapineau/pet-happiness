...
d3.csv("assets/data/fish_data_for_chart.csv", function(err, data) {
  if (err) throw err;
...
var toolTip = d3.tip()
    ...
    .offset([-10, 0])
    .html(function(d) {
      return (`${d.country}<br>Fish:Human Ratio: ${d.dpc}<br>Nat'l Happiness Score: ${d.nhs}`);
  });
...
.attr("class", "axisText")
.text("Fish:Human Population Ratio");
